                ...
                children: [
                  pw.Container(
                    ...
                    decoration: const pw.BoxDecoration(
                      border: pw.Border(bottom: pw.BorderSide(color: PdfColors.blueGrey300, width: 2)),
                    ),
                    child: pw.Row(
                          ...
                          pw.Row(
                            children: [
                              ...
                              pw.Column(
                                crossAxisAlignment: pw.CrossAxisAlignment.start,
                                children: [
                                  pw.Text("St. Mary's School", style: pw.TextStyle(fontSize: 22, fontWeight: pw.FontWeight.bold, color: PdfColors.blue900)),
                                  pw.Text("Attendance Report - $titleStr", style: pw.TextStyle(fontSize: 14, color: PdfColors.grey700)),
                                ]
                              )
                            ]
                          ),
                          pw.Text("Generated: ${DateFormat('dd MMM yyyy, hh:mm a').format(DateTime.now())}", style: const pw.TextStyle(fontSize: 10, color: PdfColors.grey600)),
                        ]
                    ),
                  ),
                  ...
                  pw.TableHelper.fromTextArray(
                    ...
                    headerHeight: 25,
                    cellHeight: 25,
                    headerStyle: pw.TextStyle(color: PdfColors.blue900, fontWeight: pw.FontWeight.bold, fontSize: 10),
