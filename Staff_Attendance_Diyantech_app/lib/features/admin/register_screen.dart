      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            const Text("Employee Registration", style: TextStyle(color: Colors.black87, fontSize: 24, fontWeight: FontWeight.bold)),
            const SizedBox(height: 30),
            TextField(controller: _nameCtrl, style: const TextStyle(color: Colors.black87), decoration: _inputDecoration("Full Name", Icons.person)),
              ...
              children: [
                Expanded(
                  ...
                  child: DropdownButtonFormField<String>(
                    ...
                    items: ['SMSZC', 'SMSTM', 'SMSAD', 'SMSOA', 'SMSAO', 'SMSTS', 'SMSSG', 'SMSNS', 'SMSPT'].map((p) => DropdownMenuItem(value: p, child: Text(p))).toList(),
                    onChanged: (val) => setState(() => _regPrefix = val!),
                  ),
                ),
                const SizedBox(width: 8),
                const Text("47", style: TextStyle(color: Colors.black87, fontSize: 18, fontWeight: FontWeight.bold)),
                const SizedBox(width: 8),
                Expanded(
                  flex: 2,
                  child: TextField(
            ...
            // Department Dropdown
            if (_regPrefix != 'SMSSG' && _regPrefix != 'SMSNS') ...[
              DropdownButtonFormField<String>(
                ...
                items: [
                  ...
                  'Botany', 'Zoology', 'History', 'Physics', 'Commerce', 'Admin Office (English)', 'Admin Office (Commerce)',
            ...
            // Zone Dropdown
            if (_regPrefix != 'SMSSG' && _regPrefix != 'SMSNS' && _regPrefix != 'SMSTM') ...[
              DropdownButtonFormField<String>(
                value: _zone,
                dropdownColor: Colors.white,
                style: const TextStyle(color: Colors.black87),
                decoration: _inputDecoration("Zone", Icons.map),
                items: ['LKG', 'UKG', 'Pre KG', 'Secondary', 'Primary'].map((z) => DropdownMenuItem(value: z, child: Text(z))).toList(),
            ...
            DropdownButtonFormField<String>(
              ...
              items: ['Teaching Staff', 'Non-Teaching Staff', 'Admin', 'BUS DRIVER', 'SECURITY GUARD'].map((d) => DropdownMenuItem(value: d, child: Text(d))).toList(),
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: const Text("Start 3D Face Scan", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.white)),
              ),
            ),
            const SizedBox(height: 16),
            SizedBox(
              ...
              child: OutlinedButton.icon(
                ...
                label: const Text("Upload Photos", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.orangeAccent)),
